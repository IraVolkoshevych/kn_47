...
('table', 'wood', 399, 'quad', 1),
('sofa', 'hardwood', 5169, 'double', 1),
('table', 'wood', 456, 'quad', 2),
('ottoman', 'linen fabric', 189, 'single', 2),
('sofa', 'hardwood', 1230, 'double', 2),
('ottoman', 'linen fabric', 158, 'single', 3),
('sofa', 'hardwood', 9854, 'double', 3),
('sofa', 'hardwood', 7954, 'double', 4),
('table', 'wood', 912, 'quad', 5),
('table', 'wood', 485, 'quad', 5),
('sofa', 'hardwood', 5985, 'double', 3),
('table', 'wood', 658, 'quad', 3),
('ottoman', 'linen fabric', 201, 'single', 4),
('sofa', 'hardwood', 1120, 'double', 5),
('ottoman', 'linen fabric', 149, 'single', 4),
('sofa', 'hardwood', 9500, 'double', 1),
('sofa', 'hardwood', 7999, 'double', 2),
('table', 'wood', 930, 'quad', 2),--
('table', 'wood', 320, 'quad', 3),
('sofa', 'hardwood', 3500, 'double', 3),
('table', 'wood', 1200, 'quad', 5),
('ottoman', 'linen fabric', 256, 'single', 1),
('sofa', 'hardwood', 1360, 'double', 3),
('ottoman', 'linen fabric', 250, 'single', 5),
('sofa', 'hardwood', 10020, 'double', 4),
('sofa', 'hardwood', 8100, 'double', 3),
('table', 'wood', 716, 'quad', 5),
('table', 'wood', 452, 'quad', 4),
('sofa', 'hardwood', 5790, 'double', 2),
('table', 'wood', 690, 'quad', 5),
('ottoman', 'linen fabric', 220, 'single', 4),
('sofa', 'hardwood', 1290, 'double', 2),
('ottoman', 'linen fabric', 165, 'single', 5),
('sofa', 'hardwood', 9500, 'double', 3),
('sofa', 'hardwood', 7620, 'double', 1),
('table', 'wood', 939, 'quad', 5);
