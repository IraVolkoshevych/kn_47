...
namespace Lab4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Результат: " + d.CalculateX(m1));
        }
    }
    ...
    class Decomposition
    {
        ...
        private double b1 { get { return 25; } }

        private double b2 { get { return 25.00 / Math.Pow(i, 3); } }

        private double C { get { return 25.00 / Math.Pow(i + j, 3); } }
