...
('table', 'wood', 399, 'quad', GETDATE()),
('sofa', 'hardwood', 5169, 'double', GETDATE()),
('table', 'wood', 456, 'quad', GETDATE()),
('ottoman', 'linen fabric', 189, 'single', GETDATE()),
('sofa', 'hardwood', 1230, 'double', GETDATE()),
('ottoman', 'linen fabric', 158, 'single', GETDATE()),
('sofa', 'hardwood', 9854, 'double', GETDATE()),
('sofa', 'hardwood', 7954, 'double', GETDATE()),
('table', 'wood', 912, 'quad', GETDATE()),
('table', 'wood', 485, 'quad', GETDATE()),
('sofa', 'hardwood', 5985, 'double', GETDATE()),
('table', 'wood', 658, 'quad', GETDATE()),
('ottoman', 'linen fabric', 201, 'single', GETDATE()),
('sofa', 'hardwood', 1120, 'double', GETDATE()),
('ottoman', 'linen fabric', 149, 'single', GETDATE()),
('sofa', 'hardwood', 9500, 'double', GETDATE()),
('sofa', 'hardwood', 7999, 'double', GETDATE()),
('table', 'wood', 930, 'quad', GETDATE()),--
('table', 'wood', 320, 'quad', GETDATE()),
('sofa', 'hardwood', 3500, 'double', GETDATE()),
('table', 'wood', 1200, 'quad', GETDATE()),
('ottoman', 'linen fabric', 256, 'single', GETDATE()),
('sofa', 'hardwood', 1360, 'double', GETDATE()),
('ottoman', 'linen fabric', 250, 'single', GETDATE()),
('sofa', 'hardwood', 10020, 'double', GETDATE()),
('sofa', 'hardwood', 8100, 'double', GETDATE()),
('table', 'wood', 716, 'quad', GETDATE()),
('table', 'wood', 452, 'quad', GETDATE()),
('sofa', 'hardwood', 5790, 'double', GETDATE()),
('table', 'wood', 690, 'quad', GETDATE()),
('ottoman', 'linen fabric', 220, 'single', GETDATE()),
('sofa', 'hardwood', 1290, 'double', GETDATE()),
('ottoman', 'linen fabric', 165, 'single', GETDATE()),
('sofa', 'hardwood', 9500, 'double', GETDATE()),
('sofa', 'hardwood', 7620, 'double', GETDATE()),
('table', 'wood', 939, 'quad', GETDATE());

insert into furniture_store values('Lviv', 'Lviv', 'Lukasha, 48', '13', GETDATE());
insert into furniture_store values('Kyiv', 'Kyiv', 'Lukasha, 4', '3', GETDATE());
insert into furniture_store values('Odessa', 'Odess', 'Lukasha, 20', '8', GETDATE());
insert into furniture_store values('Ternopil', 'Gusiatyn', 'Lukasha, 8', '9', GETDATE());
insert into furniture_store values('Lviv', 'Lviv', 'Lukasha, 8', '13', GETDATE());
...
WHILE @idClient > 0
	BEGIN
		...
		WHILE @idEmployee > 0
		BEGIN
			DECLARE @idFurnitureStore int; 
			SET @idFurnitureStore = 5; 

			WHILE @idFurnitureStore > 0
			BEGIN
				...
				WHILE @idProduct > 0
				BEGIN
					insert into form values (@idClient, @idFurnitureStore, '2017-09-24', GETDATE());
					DECLARE @idFrom int; 
					SET @idFrom = SCOPE_IDENTITY();

					insert into FROM_PRODUCTS_LINK values (@idProduct, @idFrom);
					insert into FROM_EMPLOYEES_LINK values (@idEmployee, @idFrom);
					SET @idProduct = @idProduct - 1
				END
				SET @idFurnitureStore = @idFurnitureStore - 1
			END
